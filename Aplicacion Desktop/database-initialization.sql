...
-- --------------------------------------------------
-- Date Created: 11/20/2018 22:46:23
...
GO
IF OBJECT_ID(N'[DROPEADORES].[FuncionalidadesXRoles]', 'U') IS NOT NULL
    DROP TABLE [DROPEADORES].[FuncionalidadesXRoles];
GO
...
GO
IF OBJECT_ID(N'[DROPEADORES].[TarjetaCreditoes]', 'U') IS NOT NULL
    DROP TABLE [DROPEADORES].[TarjetaCreditoes];
GO
...
-- Creating primary key on [rolId], [funcionalidadId] in table 'FuncionalidadXRoles'
ALTER TABLE [DROPEADORES].[FuncionalidadXRoles]
ADD CONSTRAINT [PK_FuncionalidadXRoles]
    PRIMARY KEY NONCLUSTERED ([rolId], [funcionalidadId] ASC);
GO
...
ALTER TABLE [DROPEADORES].[FuncionalidadXRoles]
ADD CONSTRAINT [FK__Funcional__funci__47DBAE45]
    FOREIGN KEY ([funcionalidadId])
    REFERENCES [DROPEADORES].[Funcionalidades]
        ([id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK__Funcional__funci__47DBAE45'
CREATE INDEX [IX_FK__Funcional__funci__47DBAE45]
...
ALTER TABLE [DROPEADORES].[FuncionalidadXRoles]
ADD CONSTRAINT [FK__Funcional__rolId__46E78A0C]
    FOREIGN KEY ([rolId])
